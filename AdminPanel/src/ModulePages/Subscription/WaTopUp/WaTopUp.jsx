...
import WaTopUpTable from "./WaTopUpTable";
...
const WaTopUp = () => {
  ...
  const createTopUp = () => {
    navigate("/create-top-up/create/null", { state: { topup_type: "WhatsApp" } });
  };

  const onClickViewTopUp = (topup_id) => {
    navigate("/create-top-up/view/" + topup_id, { state: { topup_type: "WhatsApp" } });
  };

  const onClickEditTopUp = (topup_id) => {
    navigate("/create-top-up/edit/" + topup_id, { state: { topup_type: "WhatsApp" } });
  };

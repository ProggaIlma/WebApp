  ...
  const prdList = [
    {
      ...
      level: 2,
      title: "Subscription",
      routePath: "/subscription-layout/subscription",
    },
    {
      name: "WA Top Up",
      level: 2,
      title: "WA Top Up",
      routePath: "/subscription-layout/wa-top-up",
    },
    {
      name: "AI Top Up",
      level: 2,
      title: "AI Top Up",
      routePath: "/subscription-layout/ai-top-up",
    },
  ];
  const locationList = {
    "/subscription-layout/subscription": 0,
    "/subscription-layout/wa-top-up": 1,
    "/subscription-layout/ai-top-up": 2,
  };
  return (

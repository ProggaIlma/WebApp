          ...
          <Container maxWidth="lg">
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={4} display="flex" flexDirection="column" >
                ...
                <Box mt={2} display="flex" justifyContent="center">
                  <Box display="flex" >
                    <img src={'/assets/images/visa.jpg'} alt="Visa" style={{ width: '40px', margin: '0 8px' }} />
                    <img src={'/assets/images/mastercard.jpg'} alt="MasterCard" style={{ width: '40px', margin: '0 8px' }} />
                    <img src={'/assets/images/paypal.jpg'} alt="PayPal" style={{ width: '40px', margin: '0 8px' }} />
                  </Box>
                </Box>
              </Grid>
              {/* Top Categories */}
